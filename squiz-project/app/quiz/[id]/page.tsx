                      ...
                      <CardContent className="p-4">
                        ...
                        {question.question_type === "open_ended" && (
                          <div className="space-y-2">
                            <div className="bg-gray-50 p-3 rounded">
                              ...
                              <p><MathTextRenderer text={userAnswer?.toString() || "Cavab verilməyib"} /></p>
                            </div>
                            {results.question_results?.[question.id]?.expected_answer && (
                              <div className="bg-green-50 p-3 rounded">
                                <p className="text-sm text-green-700 mb-1">Gözlənilən cavab:</p>
                                <p><MathTextRenderer text={results.question_results[question.id].expected_answer} /></p>
                              </div>
                            )}
                          </div>
                        )}
                        ...
                        {question.explanation && (
                          <div className="mt-3 p-3 bg-blue-50 rounded">
                            ...
                            <p className="text-sm"><MathTextRenderer text={question.explanation} /></p>
                          </div>
                        )}
                      </CardContent>
                    </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl leading-relaxed">
                  <MathTextRenderer text={currentQuestion.question_text} />
                </CardTitle>
              </CardHeader>
