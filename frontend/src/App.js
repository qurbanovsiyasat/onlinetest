...
function UserTakeQuiz({ quiz, currentQuestionIndex, setCurrentQuestionIndex, userAnswers, selectAnswer, nextQuestion, submitQuiz, setCurrentView, isSubmittingQuiz }) {
